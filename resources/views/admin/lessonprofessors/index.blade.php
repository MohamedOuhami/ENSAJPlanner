...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.lessonprofessors.create',$lesson_id) }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('school_class_delete')
                                        <form action="{{ route('admin.timetables.destroy', $lesson_id) }}"
