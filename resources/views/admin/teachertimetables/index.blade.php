...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.teachertimetables.create',$timetable_id) }}">
    ...
    <div class="card">
        <div class="card-header">
            Liste des professeurs par Emploi du temps
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('school_class_delete')
                                        <form action="{{ route('admin.timetables.destroy', $timetable_id) }}"
